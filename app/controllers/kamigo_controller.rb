...
class KamigoController < ApplicationController
  ...
  def chooselunch(received_text)
    ...
    return nil unless received_text[0..3] == '午餐吃啥'
     ...
     ['晨間廚房','武媽媽','81HOME','豪緯麵食館','鍋道一號中正大學店','7-11','吃我','不要吃','三米藍','全家','大四喜牛肉麵','伊卓島','地中海','龍座','黃媽媽','泰麻吉','品味香','洪媽媽','阿寶','123早餐屋','早餐吃啥','麥當勞','肯德基','初八拉麵','鹿初Brunch','布格早午餐','吉多多早午餐店','歐伊系精緻早餐','豐正食堂','阿基鍋燒麵','窩不知道'].sample
  end
...
# 關鍵字回覆
  ...
  def reply_to_line(reply_text)
    reply_text = ['蛤','三小','哈哈','喔是喔','你說的都對','好喔','靠邀','白爛','好笑嗎','好問題呢','寶','520','7414','幹不要','不知道ㄟ','真的喔','好很喔','好強喔','你這人真噁心','你很棒','三小','為什麼','什麼拉','再一年','怎麼了','這到底是三小','好醜喔','睡起來就好了','你在搞啥','對阿','真的差不多','真假','怎','喔','好貼心喔','吐了','別搞笑','真的ㄟ'].sample if reply_text.nil?
